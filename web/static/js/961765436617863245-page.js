...
<a  class="sl_h_2212127897837223" style="margin-left:5px" href="/home"> 

  Домой </a>
</button>
</li>
<li><button type="button" class="btn_sidebar btn btn-light">
<a  class="sl_h_2212127897837223" href="/searcher" title="Search">
...
<li><button type="button" class="btn_sidebar btn btn-light">
<a  class="sl_h_2212127897837223" href="/tags/startup" title="Search">
<img src="/js/svg/lightbulb.svg" />
 Стартап
</a>
</button>
</li>
...
<hr /><div class="head_sidebar_433535_2 sh_hd798789798_ds">
<li>
<span>About</span>
</li></br>
<li>
...
<div id="tags"></div>
<div id="filter"><h1 style="color:#8198e9"><button class="btn_fl_st btn_lk"> Фильтр ✦ </button><button class="btn_fl btn_lk"> Избранное ◉ </button></h1><button class="btn_drop">⌗  ▿ </button><button class="btn_dropdown">Фильтр  ▿ </button><div class="btn_m"><li><button class="btn_dropdowns_item" value="1" >Новее</button></li><li><button class="btn_dropdowns_item" value="2">По цене</button></li></div></div>
</br>
...
export default async function renderHomePage() {
    ...
    timeline = await timelines(but,searchQuery)   
...
alert()
   ...
   div3.innerHTML+="<style>.post-item{min-height: 100px; box-shadow:none;} #timeline-list{ margin-bottom: 60px;}  .post-content, .tagi, .reader, .readmore, .post-item br {display:none;} .reader{display:none;}.amounter{display: inline-block;} .bl_pt{float:right;} .dv_p12323243{ display:none;}</style>"
 ...
 */
function timelines (but, search, lv_n,lv_m, lv_e,tm_o,tm_a,tp_h,tp_a,hr_m,hr_b,pr_b,pr_p, before = 0) {
